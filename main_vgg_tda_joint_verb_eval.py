...
def main():
    ...
    parser.add_argument('--model', type=str, default='vgg_tda_verb_joint')
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--seed', type=int, default=1111, help='random seed')
    parser.add_argument('--clip_norm', type=float, default=0.25)
    parser.add_argument('--num_workers', type=int, default=3)

    parser.add_argument('--vgg_model', type=str, default='', help='Pretrained vgg model')
    parser.add_argument('--tda_model', type=str, default='', help='Pretrained topdown model')
    ...
    model = getattr(vgg_tda_joint_verb_eval, constructor)(vgg_model, tda_model)
