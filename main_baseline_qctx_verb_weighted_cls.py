...
from sr.model import baseline_qctx_verb_weighted_cls, top_down_query_context_pretrained_baseline, top_down_baseline
...
def main():
    ...
    model = getattr(baseline_qctx_verb_weighted_cls, constructor)(baseline, qctx_model, encoder.get_num_labels(), encoder)
