...
from sr.model import vgg_caq_joint_eval, single_role_vgg_classifier, top_down_baseline
...
def main():
    ...
    parser.add_argument('--tda_model', type=str, default='', help='Pretrained tda model')
    ...
    utils.load_net(args.tda_model, [model.caq_model])
