...
from sr.model import top_down_baseline_addemb
...
def main():
    ...
    model = getattr(top_down_baseline_addemb, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
