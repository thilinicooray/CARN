...
from sr.model import final_model_full_iter
...
def main():
    ...
    model = getattr(final_model_full_iter, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
