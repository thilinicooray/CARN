...
from sr.model import relative_fusioner_selfatt
...
def main():
    ...
    parser.add_argument('--model', type=str, default='relative_fusioner_selfatt')
    ...
    model = getattr(relative_fusioner_selfatt, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
