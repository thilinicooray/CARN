...
from sr.model import top_down_img_as_ctx
...
def main():
    ...
    parser.add_argument('--model', type=str, default='top_down_img_as_ctx')
    ...
    model = getattr(top_down_img_as_ctx, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
