...
from sr.model import contextualized_reasoner_full
...
def main():
    ...
    parser.add_argument('--model', type=str, default='contextualized_reasoner_full')
    ...
    model = getattr(contextualized_reasoner_full, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
    ...
    if args.resume_training:
        ...
        optimizer = torch.optim.Adamax([
            ...
            {'params': model.multi_ans_attention.parameters()},
