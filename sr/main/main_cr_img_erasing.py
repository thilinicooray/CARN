...
from sr.model import cr_img_erasing
...
def main():
    ...
    model = getattr(cr_img_erasing, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
