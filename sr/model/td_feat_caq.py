...
class Top_Down_Baseline(nn.Module):
    def __init__(self, convnet, role_emb, verb_emb, v_att, q_net, v_net, neighbour_attention, updated_query_composer, Dropout_C, classifier, encoder):
...
def build_top_down_query_context_only_baseline(n_roles, n_verbs, num_ans_classes, encoder):
    ...
    return Top_Down_Baseline(covnet, role_emb, verb_emb, v_att, q_net,
