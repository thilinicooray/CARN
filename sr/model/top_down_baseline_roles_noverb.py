...
class Top_Down_Baseline(nn.Module):
    def __init__(self, convnet, role_emb, query_composer, v_att, q_net, v_net, classifier, encoder, Dropout_C):
...
def build_top_down_baseline(n_roles, n_verbs, num_ans_classes, encoder):
    ...
    query_composer = FCNet([word_embedding_size, hidden_size])
    ...
    return Top_Down_Baseline(covnet, role_emb, query_composer, v_att, q_net,
