...
class Top_Down_Baseline(nn.Module):
    def __init__(self, convnet, role_emb, verb_emb, query_composer, v_att, q_net, v_net, Dropout_C, classifier, encoder, reconstruct_img):
    ...
    def calculate_loss(self, gt_verbs, role_label_pred, gt_labels):
        ...
        return final_loss_entropy


def build_top_down_img_as_ctx(n_roles, n_verbs, num_ans_classes, encoder):
