...
class Top_Down_Baseline(nn.Module):
    def __init__(self, cai_model, flatten_img, reconstruct_img, encoder):
...
def build_caq_cai_joint(cai_model, encoder):
    ...
    return Top_Down_Baseline(cai_model, flatten_img, reconstruct_img, encoder)