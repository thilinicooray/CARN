...
class Top_Down_Baseline(nn.Module):
    def __init__(self, convnet, role_emb, verb_emb, query_composer, v_att, q_net, v_net, neighbour_attention,
                 updated_query_composer, Dropout_C, flatten_img, reconstruct_img, classifier, encoder):
...
def build_top_down_query_ctx_with_img_recons(n_roles, n_verbs, num_ans_classes, encoder):
