...
from sr.model import top_down_query_context_pretrained_baseline_iter, top_down_baseline
...
def main():
    ...
    model = getattr(top_down_query_context_pretrained_baseline_iter, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder, baseline)
    ...
    if args.resume_training:
        ...
        optimizer = torch.optim.Adamax([
            ...
            {'params': model.iter_att.parameters()},
