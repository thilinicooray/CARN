...
from sr.model import top_down_baseline_roles_noverb
...
def main():
    ...
    model = getattr(top_down_baseline_roles_noverb, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
