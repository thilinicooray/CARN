...
from sr.model import adaptive_base_qctx_ctxsep
...
def main():
    ...
    model = getattr(adaptive_base_qctx_ctxsep, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
