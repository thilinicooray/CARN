...
from sr.model import quesry_ctx_with_img_construct
...
def main():
    ...
    parser.add_argument('--model', type=str, default='top_down_query_ctx_with_img_recons')
    ...
    model = getattr(quesry_ctx_with_img_construct, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
