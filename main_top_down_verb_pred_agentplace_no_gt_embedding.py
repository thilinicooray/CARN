...
from sr.model import top_down_verbb_pred_agentplace_no_gt_embedding, single_role_vgg_classifier
...
def main():
    ...
    model = getattr(top_down_verbb_pred_agentplace_no_gt_embedding, constructor)(len(encoder.agent_label_list), len(encoder.place_label_list),
