...
def main():
    ...
    model = getattr(top_down_query_context_pretrained_baseline_nocaqatt, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder, baseline)
