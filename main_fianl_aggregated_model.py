...
from sr.model import final_aggregated_model
...
def main():
    ...
    model = getattr(final_aggregated_model, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
