...
from sr.model import top_down_image_context_pretrained_baseline, top_down_baseline
...
def main():
    ...
    model = getattr(top_down_image_context_pretrained_baseline, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder, baseline)
