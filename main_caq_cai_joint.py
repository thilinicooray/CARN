...
from sr.model import caq_cai_combine, top_down_query_context_pretrained_baseline, top_down_image_context_pretrained_baseline, top_down_baseline
...
def main():
    ...
    model = getattr(caq_cai_combine, constructor)(caq_model, cai_model, encoder)
