...
from sr.model import top_down_gru_emb
...
def main():
    ...
    model = getattr(top_down_gru_emb, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
