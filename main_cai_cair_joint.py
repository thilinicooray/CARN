...
from sr.model import cai_cair_joint, top_down_query_context_pretrained_baseline, top_down_image_context_pretrained_baseline, top_down_baseline
...
def main():
    ...
    model = getattr(cai_cair_joint, constructor)(cai_model, encoder)
    ...
    if args.resume_training:
        ...
        utils.set_trainable(model.cai_model.classifier, True)
        optimizer = torch.optim.Adamax([
            {'params': model.cai_model.q_net.parameters(), 'lr': 5e-5},
            {'params': model.cai_model.v_net.parameters(), 'lr': 5e-5},
            {'params': model.cai_model.classifier.parameters(), 'lr': 5e-5},
