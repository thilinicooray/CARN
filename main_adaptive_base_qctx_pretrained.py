...
from sr.model import adaptive_base_qctx_pretrained, top_down_query_context_pretrained_baseline, top_down_baseline
...
def main():
    ...
    parser.add_argument('--model', type=str, default='adaptive_base_qctx')
    ...
    model = getattr(adaptive_base_qctx_pretrained, constructor)(encoder.get_num_labels(), encoder, baseline, qctx_model)
