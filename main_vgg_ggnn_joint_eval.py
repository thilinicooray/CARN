...
from sr.model import vgg_caq_joint_eval, single_role_vgg_classifier, ggnn_baseline
...
def main():
    ...
    tda_role_module = getattr(ggnn_baseline, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)

    constructor = 'build_%s' % args.model
    model = getattr(vgg_caq_joint_eval, constructor)(vgg_verb_model, tda_role_module)
    ...
    utils.load_net(args.ggnn_model, [model.caq_model])
