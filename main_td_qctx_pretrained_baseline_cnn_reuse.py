...
from sr.model import td_qctx_pretrained_baseline_cnn_reuse, top_down_baseline
...
def main():
    ...
    model = getattr(td_qctx_pretrained_baseline_cnn_reuse, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder, baseline)
